...
/**/
/**/
console.log("tutto inizia da qui");
$(document).ready(function () {
  ...
  (function ($) {
    ...
    $(document.body).on("click", ".btn-delete-product", function () {
      var $post = $(this).closest(".post");
      var productId = $post.data("id"); // Prendi l'ID del prodotto
      console.log("elimina", productId);
      // Esegui una richiesta AJAX per eliminare il prodotto dal database
      $.ajax({
