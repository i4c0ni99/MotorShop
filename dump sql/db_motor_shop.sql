...
INSERT INTO users (`email`, `shipping_address_id`, `name`, `surname`, `password`, `phone`) VALUE
    ( 'admin@gmail.com', NULL, 'Luigi', 'Visconti',MD5(MD5('admin')), '3921346140');
...
INSERT INTO `groups_has_services` ( `services_id`, `groups_id`) VALUES (1,1),(3,1),(5,1),(2,2),(3,2),(4,2),(6,1),(7,2),
                                                                       (2,1),(8,1),(8,2),(9,1),(10,1),(11, 1),(11,2);