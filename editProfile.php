...
$img=$data->fetch_assoc();
   if($img['avatar']==null){
    ...
    if (isset($_POST['add-address-button'])) {
        ...
        $oid = $mysqli->query("INSERT INTO shipping_address (users_email, name, surname, province, city, streetAddress, cap) VALUES ('".$_SESSION['user']['email']."', '$name', '$surname', '$phone', '$province', '$city', '$address', '$cap'");
