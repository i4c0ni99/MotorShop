...
if (isset($_SESSION['user']) && (isset($_GET['id']))) {
    ...
    $order_status_query = $mysqli->query("SELECT state, shipping_address_id FROM orders WHERE id = '{$order_id}'");
    ...
    if ($order_status_query && $order_status_query->num_rows > 0) {
        ...
        $body->setContent("id", $order_status_data['shipping_address_id']);
        $address = $order_status_data['shipping_address_id'];
