...
require "include/dbms.inc.php"; // Assicurati che questo file includa la connessione al database
...
if (isset($_GET['email']) && isset($_GET['v_cod'])) {
    ...
    if (!$conn) {
        echo "<script>alert('Errore di connessione al database.'); window.location.href='/MotorShop/login.php'</script>";
        exit();
    }
