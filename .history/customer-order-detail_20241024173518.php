...
if (isset($_SESSION['user']['groups']) == 1) {
...
WHERE 
    ...
    $main = new Template("/Applications/XAMPP/xamppfiles/htdocs/MotorShop/skins/multikart_all_in_one/back-end/order-detail.html/frame-private.html");
