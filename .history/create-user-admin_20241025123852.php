    ...
    if (isset($_POST['email'], $_POST['name'], $_POST['surname'], $_POST['password'], $_POST['confirmPassword'])) {
        ...
        if ($_POST['password'] != $_POST['confirmPassword']) {
            ...
            if ($unique === "unique") {
                ...
                $criptoPass = md5(md5($_POST['password'])); // Non è consigliato utilizzare MD5 per l'hashing sicuro delle password
                ...
                if ($mysqli->query($insertUserQuery)) {
                    // Inserisce l'utente nel gruppo 2 (presumo sia il gruppo per gli amministratori)
                    ...
                    // Redirect o altre azioni dopo l'inserimento riuscito
                    header("Location: /MotorShop/user-admin.php");
                    exit();
                } else {
