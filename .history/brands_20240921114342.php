...
session_start(); // Assicurati che la sessione venga avviata
...
if (isset($_SESSION['user'])) {
    ...
    // Gestione dell'eliminazione della categoria tramite parametro GET 'elimina'
    if (isset($_GET['elimina']) && is_numeric($_GET['elimina'])) {
        $category_id = intval($_GET['elimina']);
        
        // Esegui la query per eliminare la categoria
    ...
    // Ottieni tutte le categorie ordinate per nome
