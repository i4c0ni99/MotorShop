...
while ($cartItem = $result->fetch_assoc()) {
    ...
    // (Il resto del tuo codice per elaborare i cartItem)
    
    // Se trovi articoli nel carrello, imposta checkoutDisabled su false
    $checkoutDisabled = false; 
    // (Aggiungi i dati del prodotto all'array)
}

// Passa la variabile checkoutDisabled al template
