...
$product_query_base ="
    ...
    WHERE EXISTS (SELECT 1 FROM sub_products WHERE sub_products.products_id = products.id) AND sub_productsAND products.availability = 1";
...
$count_query = "SELECT COUNT(*) as total_products FROM products WHERE 1=1";
