...
// Imposta il contenuto del body per ogni indirizzo
foreach ($addresses as $address) {
    $body->setContent("addressId", $address['id']);
    $body->setContent("addressName", htmlspecialchars($address['name']));
    $body->setContent("addressSurname", htmlspecialchars($address['surname']));
    $body->setContent("addressStreet", htmlspecialchars($address['streetAddress']));
    $body->setContent("addressCap", htmlspecialchars($address['cap']));

    // Appendere la riga all'output della tabella
    $body->appendContent("addressesTable", $body->getPartial("addressRowTemplate"));
}
