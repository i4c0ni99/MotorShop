...
$subcategories = $mysqli->query("SELECT name FROM categories where id={$result['categories_id']}");
$subcategory = $categories->fetch_assoc();
$body->setContent('subcategory', $category['name']);
