...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $queryCart = "SELECT c.subproduct_id, c.quantity, sp.price, sp.availability, sp. quantity AS sp.stock, 
              FROM cart c 
...
if ($resultCart) {
    ...
    $products = []; // Array per salvare i dettagli dei prodotti
     ...
     // Calcola importo totale e salva i dati dei prodottidel totale dell'ordine e costruzione dei dettagli del prodotto
     while ($row = $resultCart->fetch_assoc()) {
        ...
        $products[] = [
            ...
            // Prodotto non disponibile o quantità richiesta non sufficiente
...
if ($mysqli->query($insertOrderQuery)) {
    ...
    // Loop attraverso i prodotti validi per l'ordine
