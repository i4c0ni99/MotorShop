...
<div class="mv-pagination-wrapper">
    <div class="mv-pagination-style-1 has-count-post">
        <div class="count-post mv-title-style-10">
            <span class="number"><?= $total_products ?></span> Prodotti in <span
    class="number"><?= $total_pages ?></span> Pagine
</div>
...
<div class="product-list">
    ...
    while ($product = $product_result->fetch_assoc()) {
        echo '<div class="product-item">' . htmlspecialchars($product['title']) . '</div>';
    }
    ?>
</div>
