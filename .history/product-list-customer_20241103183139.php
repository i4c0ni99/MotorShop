...
// condizione per il filtro di testo di ricerca 
...
// condizione per il filtro di prezzo nella query di conteggio
if(isset($_GET['size'])){
...
// condizione per il filtro di testo di ricerca se specificato nella query di conteggio
if (isset($_GET['search_text']) && !empty($_GET['search_text'])) {
    $searchText = $mysqli->real_escape_string($_GET['search_text']);
}
