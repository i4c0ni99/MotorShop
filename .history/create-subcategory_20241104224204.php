...
// Verifica presenza e validità del parametro categories_id
if (!isset($_GET['categories_id']) || !is_numeric($_GET['categories_id'])) {
    echo "Parametro categories_id non valido.";
    exit;
}

// ID della categoria dal parametro passato nell'URL
...
// sottocategorie correlate all'ID della categoria
