...
$items_per_page = 12;
$total_items = /* numero totale di prodotti, ad esempio, da un database */;
$currentPage = isset($_GET['page']) ? (int)$_GET['page'] : 1;

// Calcolo del totale delle pagine
...
// HTML per la visualizzazione della paginazione
?>
<div class="mv-pagination-wrapper">
    <div class="mv-pagination-style-1 has-count-post">
        <div class="count-post mv-title-style-10">
            <span class="number"><?= $total_items ?></span> Prodotti in <span class="number"><?= $total_pages ?></span>
            Pagine
        </div>
