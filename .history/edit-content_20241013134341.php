...
if (isset($_SESSION['user']) && $_SESSION['user']['groups'] == '1') {
    ...
    if (isset($_POST['file'])) {
        $file = $_POST['file'];
        $allowedFiles = ['skins/motor-html-package/motor/privacy-policy.html', 'skins/motor-html-package/motor/refund.html', 'skins/motor-html-package/motor/shipping.html'];
