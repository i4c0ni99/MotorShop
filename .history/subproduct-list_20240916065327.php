...
if (isset($_GET['id'])) {
    ...
    if ($sub_result->num_rows > 0) {
        ...
        foreach ($subProducts as $subProduct) {
            ...
            $data = $mysqli->query("SELECT imgsrc FROM images WHERE sub_products_id={$subproduct['id']} LIMIT 1"); $query = "SELECT imgsrc FROM images WHERE sub_products_id = " . (int)$subProduct['id'] . " LIMIT 1";
            if ($data->num_rows > 0) {
